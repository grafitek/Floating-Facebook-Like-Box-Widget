...
<script type = "text/javascript" language = "javascript">$(document).ready(function() {$('#scroll').hover(function () {$(this).animate({"right":"0px"},350);},function () {$(this).animate({"right":"-344px"},350);});});</script>
...
.fb-att{float: right;}
.fb-att a{text-decoration: none; color: white; font-size: 10px; background: #2851A3; padding: 3px; display: block;}
.fb-att a:hover{text-decoration:underline; color:white;}</style>
